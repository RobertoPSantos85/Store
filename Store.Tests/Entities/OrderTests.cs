...
namespace Store.Tests.Domain
{
    ...
    public class OrderTests
    {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_valido_ele_deve_gerar_um_numero_com_8_caracteres()
        {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_pagamento_do_pedido_seu_status_deve_aguardando_entrega()
        {
            var order = new Order(_customer, 0, null);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_uma_de_entrega_de_10_o_valor_do_pedido_deve_ser_60()
        {
            var order = new Order(_customer, 10, _discount);
